# Copied from https://github.com/katsura-jp/pytorch-cosine-annealing-with-warmup
...
class WarmUpCosineAnnealingLR(torch.optim.lr_scheduler._LRScheduler):
    ...
    def get_lr(self):
        if self.last_epoch < self.warmup_epochs:
            ...
            return [self.eta_min + (base_lr - self.eta_min) * (1 + math.cos(math.pi * epoch_adj / (self.T_max - self.warmup_epochs))) / 2 for base_lr in self.base_lrs]
